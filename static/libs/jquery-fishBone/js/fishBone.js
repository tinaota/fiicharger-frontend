$.fn.fishBone = function(data) {
    ...
    //对应插件颜色下标，8：红色、2：橘黄、4：黄色、7：绿色
    var sourceDataColor = { "schedule": 1, "normal": 9, "abnormal": 8, "overtime": 7, "warning": 2 };
    var sourceDataColorDirection = { "schedule": "top", "normal": "bottom", "abnormal": "bottom", "overtime": "bottom", "warning": "bottom" };
    ...
    function creataFishBone(data) {
        ...
        $(data).each(function(index) {
            ...
            var itemclass = sourceDataColorDirection[data[index].colorLevel]; //显示在轴上方或下方标识 top/bottom
            ...
            if (itemclass == 'top') {
                $.each(this, function(name, value) {
                    if (name === "sourceDate") {
                        ...
                        var li = $("<li>" + value + "</li>").css("margin", "-20px 0px 0px -70px").css("height", "60px").css("width", "140px").css("line-height", "22px").css("text-align", "center");
                        li.appendTo(ul);
            ...
            if (itemclass == "bottom") {
                $.each(this, function(name, value) {
                    if (name === "sourceDate") {
                        ...
                        var li = $("<li>" + value + "</li>").css("margin", "0px 0px 0px -80px").css("height", "40px").css("width", "160px").css("line-height", "22px").css("text-align", "center");
                        li.appendTo(ul);
                        return;
                    }
                });
            ...
            li_item.addClass(itemclass).appendTo(ul_item);
        });
        ul_item.appendTo(bd);
        bd.appendTo(wrapper);
