        ...
        generatePdf() {
            let data = this.tableData.map((item) => {
                return [
                    ...
                    {
                        text:
                            item.meterTotal !== null
                                ? item.meterTotal.toFixed(2)
                                : "",
                        color: "#525E69",
                        margin: [0, 10, 0, 0],
                        fontSize: 10
                        ...
                        table: {
                            ...
                            body: [
                                [
                                    ...
                                    {
                                        text: i18n.t(
                                            "chargingStation.startIdTag"
                                        ),
                                        bold: true
                                    },
                                    {
                                        text: i18n.t(
                                            "chargingStation.stopIdTag"
                                        ),
                                        bold: true
                                    },
                                    {
